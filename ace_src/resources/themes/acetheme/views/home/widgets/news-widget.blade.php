<div class="block block-posts" data-layout="list" data-mobile-columns="1">
    <div class="container">
        <div class="block-header">
            <h3 class="block-header__title">Bản tin</h3>
            ...
            <div class="owl-carousel">
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-1.png') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        ...
                        <div class="post-card__name">
                            <a href="">Chính thức khai trương trung tâm mua sắm tại Vạn Hạnh Mall</a>
                        </div>
                        <div class="post-card__date">03/02/2020</div>
                        <div class="post-card__content">
                        ACE cung cấp các sản phẩm vệ sinh nhà
cửa chất lượng đạt các tiêu chuẩn hàng
đầu của Mỹ và đảm bảo về an toàn...
                        </div>
                ...
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-2.png') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category">
                        ...
                        <div class="post-card__name">
                            <a href="">Ưu đãi đặc biệt ngày lễ Tình Nhân tại
Home Center</a>
                        </div>
                        <div class="post-card__date">10/02/2020</div>
                        <div class="post-card__content">
                        Việc dọn dẹp nhà cửa không khi nào là dễ
 dàng với bất kỳ ai. Tuy nhiên với các dụng
 cụ chuyên dụng tại ACE...
                        </div>
                        <div class="post-card__read-more">
                            <a href="" class="btn btn-secondary btn-sm">Read More</a>
                        </div>
                ...
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-3.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category">
                ...
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-4.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category">
                ...
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-5.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category">
                ...
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-6.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category">
                ...
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-7.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category">
                ...
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-8.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category">
                ...
                <div class="post-card  ">
                    <div class="post-card__image">
                        <a href="">
                            <img src="{{ asset('/themes/acetheme/assets/images/posts/post-9.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category">
