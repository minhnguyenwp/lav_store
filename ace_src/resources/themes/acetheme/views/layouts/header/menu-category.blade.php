...
<div class="departments  departments--open departments--fixed " data-departments-fixed-by=".block-slideshow">
            ...
            <ul class="departments__links">
                <li class="departments__item">
                    <a class="departments__item-link" href="">
                        ...
                        <svg class="departments__item-arrow" width="6px" height="9px">
                            <use xlink:href="{{ asset('/themes/acetheme/assets/images/sprite.svg') }}#arrow-rounded-right-6x9"></use>
                        </svg>
                    </a>
                    <div class="departments__submenu departments__submenu--type--megamenu departments__submenu--size--xl">
                        <!-- .megamenu -->
                        <div class="megamenu  megamenu--departments ">
                            <div class="megamenu__body" style="background-image: url('{{ asset('/themes/acetheme/assets/images/megamenu/megamenu-1.jpg')}}');">
                                <div class="row">
                                    <div class="col-3">
                ...
                <li class="departments__item">
                    ...
                    <div class="departments__submenu departments__submenu--type--megamenu departments__submenu--size--lg">
                        <!-- .megamenu -->
                        <div class="megamenu  megamenu--departments ">
                            <div class="megamenu__body" style="background-image: url('{{ asset('/themes/acetheme/assets/images/megamenu/megamenu-2.jpg')}}');">
                                <div class="row">
                                    <div class="col-4">
                                        <ul class="megamenu__links megamenu__links--level--0">
                                            <li class="megamenu__item  megamenu__item--with-submenu ">
                ...
                <li class="departments__item">
                    ...
                    <div class="departments__submenu departments__submenu--type--megamenu departments__submenu--size--nl">
                        <!-- .megamenu -->
                        <div class="megamenu  megamenu--departments ">
                            <div class="megamenu__body" style="background-image: url('{{ asset('/themes/acetheme/assets/images/megamenu/megamenu-3.jpg')}}');">
                                <div class="row">
                                    <div class="col-6">
                                        <ul class="megamenu__links megamenu__links--level--0">
                                            <li class="megamenu__item  megamenu__item--with-submenu ">
    ...
    <button class="departments__button">
        <svg class="departments__button-icon" width="18px" height="14px">
            <use xlink:href="{{ asset('/themes/acetheme/assets/images/sprite.svg')}}#menu-18x14"></use>
        </svg>
        Shop By Category
        <svg class="departments__button-arrow" width="9px" height="6px">
            <use xlink:href="{{ asset('/themes/acetheme/assets/images/sprite.svg')}}#arrow-rounded-down-9x6"></use>
        </svg>
    </button>
</div>
<!-- .departments / end -->
